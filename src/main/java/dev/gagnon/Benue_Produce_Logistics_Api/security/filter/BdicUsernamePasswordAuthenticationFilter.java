package dev.gagnon.Benue_Produce_Logistics_Api.security.filter;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.fasterxml.jackson.databind.ObjectMapper;
import dev.gagnon.Benue_Produce_Logistics_Api.dto.request.LoginRequest;
import dev.gagnon.Benue_Produce_Logistics_Api.dto.response.BdicApiResponse;
...
public class BdicUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        BdicApiResponse<LoginResponse> apiResponse = new BdicApiResponse<>( true, loginResponse);
